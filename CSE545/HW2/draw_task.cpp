...
static double      movement_time = 0.25;
static double      tau;
...
init_draw_task(void)
{
  ...
  ctarget[RIGHT_HAND].x[_X_] = cart_des_state[RIGHT_HAND].x[_X_]+0.05;
  ctarget[RIGHT_HAND].x[_Y_] = cart_des_state[RIGHT_HAND].x[_Y_];
  ctarget[RIGHT_HAND].x[_Z_] = cart_des_state[RIGHT_HAND].x[_Z_]-0.03;
...
run_draw_task(void)
{
  ...
  if (tau <= 0) {
    my_times++;
      ...
      ctarget[RIGHT_HAND].x[_X_] = cart_des_state[RIGHT_HAND].x[_X_]+0.005*factor;
      ctarget[RIGHT_HAND].x[_Y_] = cart_des_state[RIGHT_HAND].x[_Y_];
      ctarget[RIGHT_HAND].x[_Z_] = cart_des_state[RIGHT_HAND].x[_Z_]-0.01*factor;
      tau = movement_time;
      run_draw_task();
    }

    else if (my_times == 3) {
      ctarget[RIGHT_HAND].x[_X_] = cart_des_state[RIGHT_HAND].x[_X_]+0.01*factor;
      ctarget[RIGHT_HAND].x[_Y_] = cart_des_state[RIGHT_HAND].x[_Y_];
      ctarget[RIGHT_HAND].x[_Z_] = cart_des_state[RIGHT_HAND].x[_Z_]-0.005*factor;
      tau = movement_time;
      run_draw_task();
    }
    else if (my_times == 4) {
...
\remarks 
	...
	state as well as movement movement_time, the next increment
 ...
 *******************************************************************************
 ...
 \param[in]     tau        : the desired movement movement_time until the goal is
	                 reached.
